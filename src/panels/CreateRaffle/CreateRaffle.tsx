...
const CreateRaffle: React.FC<CreateRaffleProps> = ({ id }) => {
  ...
  const [progress, setProgress] = useState(0);
    ...
    const [blackListSel, setBlackListSel] = useState([]);
...
const communityTagOptions = [
  ...
  }, [community, giveawayName, prizeDescription, photos, currentStep, 
    participationConditions, requiredCommunities, numberWinners, blackListSel,
    publishResults, hideParticipantsCount, onlySubscribers, excludeAdmins,
  ]);
          ...
          <>
            <div className={styles.formField}>
              <Select
                ...
                value={community} // Передаем текущее значение
            ...
            <PhotoUpload
              ...
              maxPhotos={3}
              initialPhotos={photos} // Передаем текущие фото
            />
          </>
        );
